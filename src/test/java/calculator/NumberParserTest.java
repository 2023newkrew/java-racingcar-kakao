...
public class NumberParserTest {
    ...
    @Test
    @DisplayName("기본 구분자로 문자열 분할했을 때 올바른 문자열 배열을 반환한다.")
    ...
    @Test
    @DisplayName("사용자 정의 구분자로 문자열 분할했을 때 올바른 문자열 배열을 반환한다.")
    ...
    @Test
    @DisplayName("String 배열 -> Integer 배열로 올바르게 반환한다.")
    ...
    @Test
    @DisplayName("String 배열에 숫자로 변환할 수 없는 원소가 존재시 예외처리한다.")
    ...
    @Test
    @DisplayName("String 배열을 Integer 배열로 변환했을 때 음수가 있는 경우 예외처리한다.")
